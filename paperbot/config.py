...
class PipelineConfig(Config, metaclass=AutoPropertyMeta):
    def __init__(
        self, 
        use_openreview: bool = False, use_site: bool = False, use_openaccess: bool = False, use_gform: bool = False, use_arxiv: bool = False,
        fetch_openreview: bool = False, fetch_site: bool = False, fetch_openaccess: bool = False, fetch_gform: bool = False, fetch_arxiv: bool = False,
